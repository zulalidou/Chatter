...
class GroupInvitationReceived extends React.Component {
    ...
    async acceptInvitation() {
        ...
        const response = await fetch("/accept-group-invitation", {
            method: "POST",
            headers: {
    ...
    async deleteNotification() {
        ...
        const response = await fetch(`/delete-notification?userID=${this.state.userID}&groupID=${this.props.groupID}`, {credentials: "include"})

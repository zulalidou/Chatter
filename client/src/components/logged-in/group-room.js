...
class GroupRoom extends React.Component {
    ...
    async getRoomMessages(roomID) {
        const response = await fetch(`/get-room-messages?roomID=${this.props.roomID}`, {credentials: "include"})
    ...
    async getUserInfo() {
        const response = await fetch(`/get-profile-info?userID=${this.props.userID}`, {credentials: "include"})

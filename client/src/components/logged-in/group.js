...
class Group extends React.Component {
    ...
    async userReceivedGroupInvitation(groupID) {
        ...
        const response = await fetch(`/did-user-receive-invite?userID=${this.state.userID}&groupID=${groupID}`, {credentials: "include"})
    ...
    async userIsGroupMember(userID, groupID) {
        const response = await fetch(`/is-user-group-member?userID=${userID}&groupID=${groupID}`, {credentials: "include"})
    ...
    async getGroupInfo(groupID) {
        let response = await fetch(`/get-group?groupID=${groupID}`, {credentials: "include"})
    ...
    async getGroupMembers(groupID) {
        const response = await fetch(`/get-group-members?groupID=${groupID}`, {credentials: "include"})
    ...
    async getGroupRooms(groupID) {
        let response = await fetch(`/get-group-rooms?groupID=${groupID}`, {credentials: "include"})

...
class NotificationsBox extends React.Component {
    ...
    async componentDidMount() {
        ...
        if (!this.state.notificationsFetched) {
            const response = await fetch(`/get-notifications?userID=${this.props.userID}`, {credentials: "include"})
    ...
    async deleteNotification(notificationID) {
        ...
        const response = await fetch(`/delete-notification-2?notificationID=${notificationID}`, {credentials: "include"})

...
class ActivateAccount extends React.Component {
    ...
    async resendCode() {
        ...
        const response = await fetch('/send-account-activation-code', {
            method: 'POST',
            headers: {
    ...
    async verifyCode() {
        ...
        const response = await fetch(`/verify-account-activation-code?email=${this.props.location.state.email}&code=${code}`)
